...
namespace NotesApp
{
    ...
    /// </summary>
    public sealed partial class HubPage : NotesApp.Common.LayoutAwarePage
    {
        public HubPage()
        {
        ...
        {
            EnableLiveTile.CreateLiveTile.ShowliveTile(true, "Notes");
        }
        ...
        {
            this.Frame.Navigate(typeof(OverduePage));
        }
