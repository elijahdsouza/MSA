...
using UnitCalculator.SettingsFlyouts;
    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                if (!rootFrame.Navigate(typeof(Calculator), "AllGroups"))
                {
        ...
        protected async override void OnSearchActivated(Windows.ApplicationModel.Activation.SearchActivatedEventArgs args)
        {
            ...
            if (frame == null)
            {
                ...
                frame = new Frame();
                UnitCalculator.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
                ...
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    try
                    {
                        await UnitCalculator.Common.SuspensionManager.RestoreAsync();
                    }
                    catch (UnitCalculator.Common.SuspensionManagerException)
                    {
                        //Something went wrong restoring state.
                        //Assume there is no state and continue
                    }
            ...
            //frame.Navigate(typeof(GroupedItemsPage), args.QueryText);
